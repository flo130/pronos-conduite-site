...
class Twconnect extends TwitterOAuth {
	...
	public function Twconnect() {
		...
		if ( $access_token && isset($access_token['oauth_token']) && isset($access_token['oauth_token_secret']) ) {
			//echo 'Create a TwitterOauth object with consumer(app) and user tokens.' . "<br/>";
			//echo 'It is the last (third) step of Twitter OAuth process' . "<br/>";
		...
		/* Try to retrieve request token (temporary) from session */
			...
			if ( $request_token && isset($request_token['oauth_token']) && isset($request_token['oauth_token_secret']) ) {
				//echo 'Create object with request token key/secret sent previously to twitter' . "<br/>";
				//echo 'It is the second step of Twitter OAuth process' . "<br/>";
				...
				//echo 'Create object without access or request token' . "<br/>";
				//echo 'It is the first step of Twitter OAuth process' . "<br/>";
