...
class Layout
{
    ...
    public function __construct()
    {
		...
		//titre composé du nom de la méthode et du nom du contrôleur
		$this->var['title'] = $this->title . ' | ' . ucfirst($this->CI->router->fetch_class());
		 
		//variable $charset avec la même valeur que la clé de 
		//configuration initialisée dans le fichier config.php
