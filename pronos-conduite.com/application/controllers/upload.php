...
class Upload extends CI_Controller
{
	...
	public function index() 
	{
		...
		$image_path = $upload_handler->get_image_path();
		...
		$update = array('image' => $image_basename);
...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) 
	{
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/assets/images/avatar/user/',
            'upload_url' => $this->get_full_url().'/assets/images/avatar/user/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
